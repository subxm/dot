<div align="center">
  <img src="src/assets/hero.png" alt="dot. Logo" width="120" style="border-radius: 24px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);" />
...
```mermaid
flowchart TD
    A[Join dot.] --> B[Choose Tribe & Commit Daily Goal]
    B --> C{Matching Engine}
